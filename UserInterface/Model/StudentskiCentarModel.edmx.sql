...
IF OBJECT_ID(N'[dbo].[FK_domar_radnik_fk]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[domar] DROP CONSTRAINT [FK_domar_radnik_fk];
GO
IF OBJECT_ID(N'[dbo].[FK_menza_stud_centar_fk]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[menza] DROP CONSTRAINT [FK_menza_stud_centar_fk];
GO
IF OBJECT_ID(N'[dbo].[FK_popravlja_domar_fk]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[popravlja] DROP CONSTRAINT [FK_popravlja_domar_fk];
GO
IF OBJECT_ID(N'[dbo].[FK_popravlja_prijavljuje_fk]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[popravlja] DROP CONSTRAINT [FK_popravlja_prijavljuje_fk];
GO
IF OBJECT_ID(N'[dbo].[FK_prijavljuje_kvar_fk]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[prijavljuje] DROP CONSTRAINT [FK_prijavljuje_kvar_fk];
GO
IF OBJECT_ID(N'[dbo].[FK_prijavljuje_stanuje_fk]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[prijavljuje] DROP CONSTRAINT [FK_prijavljuje_stanuje_fk];
GO
IF OBJECT_ID(N'[dbo].[FK_radnik_stud_centar_fk]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[radnik] DROP CONSTRAINT [FK_radnik_stud_centar_fk];
GO
IF OBJECT_ID(N'[dbo].[FK_soba_stud_dom_fk]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[soba] DROP CONSTRAINT [FK_soba_stud_dom_fk];
GO
IF OBJECT_ID(N'[dbo].[FK_sprema_menza_fk]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[sprema] DROP CONSTRAINT [FK_sprema_menza_fk];
GO
IF OBJECT_ID(N'[dbo].[FK_sprema_spremacica_fk]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[sprema] DROP CONSTRAINT [FK_sprema_spremacica_fk];
GO
IF OBJECT_ID(N'[dbo].[FK_spremacica_radnik_fk]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[spremacica] DROP CONSTRAINT [FK_spremacica_radnik_fk];
GO
IF OBJECT_ID(N'[dbo].[FK_stanuje_soba_fk]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[stanuje] DROP CONSTRAINT [FK_stanuje_soba_fk];
GO
IF OBJECT_ID(N'[dbo].[FK_stanuje_student_fk]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[stanuje] DROP CONSTRAINT [FK_stanuje_student_fk];
GO
...
IF OBJECT_ID(N'[dbo].[domar]', 'U') IS NOT NULL
    DROP TABLE [dbo].[domar];
GO
IF OBJECT_ID(N'[dbo].[kvar]', 'U') IS NOT NULL
    DROP TABLE [dbo].[kvar];
GO
IF OBJECT_ID(N'[dbo].[menza]', 'U') IS NOT NULL
    DROP TABLE [dbo].[menza];
GO
IF OBJECT_ID(N'[dbo].[popravlja]', 'U') IS NOT NULL
    DROP TABLE [dbo].[popravlja];
GO
IF OBJECT_ID(N'[dbo].[prijavljuje]', 'U') IS NOT NULL
    DROP TABLE [dbo].[prijavljuje];
GO
IF OBJECT_ID(N'[dbo].[radnik]', 'U') IS NOT NULL
    DROP TABLE [dbo].[radnik];
GO
IF OBJECT_ID(N'[dbo].[soba]', 'U') IS NOT NULL
    DROP TABLE [dbo].[soba];
GO
IF OBJECT_ID(N'[dbo].[sprema]', 'U') IS NOT NULL
    DROP TABLE [dbo].[sprema];
GO
IF OBJECT_ID(N'[dbo].[spremacica]', 'U') IS NOT NULL
    DROP TABLE [dbo].[spremacica];
GO
IF OBJECT_ID(N'[dbo].[stanuje]', 'U') IS NOT NULL
    DROP TABLE [dbo].[stanuje];
GO
